...
public class AnnotationVideoCapturer extends BaseVideoCapturer implements Camera.PreviewCallback {
    ...
    private ReentrantLock mPreviewBufferLock = new ReentrantLock(); // sync start/stop capture and surface changes
    ...
    public AnnotationVideoCapturer(Context context) {
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        if (isCaptureRunning) {
            if (data.length == mExpectedFrameSize) {
                ...
                provideByteArrayFrame(data, BaseVideoCapturer.NV21, mCaptureWidth,
